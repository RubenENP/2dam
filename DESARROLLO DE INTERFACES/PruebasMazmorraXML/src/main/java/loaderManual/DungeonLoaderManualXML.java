...
//        </spells>
    ...
    private static List<Item> getItemsNode(Node itemsNode, String xPath) throws ItemCreationErrorException, ItemCreationErrorException {
            ...
            if (elNodoEsElemento(itemChild)) {
                ...
                switch (type.toLowerCase()) {
                    case "weapon":
                        ...
                        break;
                    case "necklace":
                        items.add(game.object.Necklace.createNecklace((Domain) domainAndLevel.get("domain"), level));
                        break;
                    case "ring":
                        items.add(game.object.Ring.createRing((Domain) domainAndLevel.get("domain"), level));
                        break;
                }
            }
        }
