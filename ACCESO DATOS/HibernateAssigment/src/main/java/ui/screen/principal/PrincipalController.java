...
public class PrincipalController {
    ...
    public void onLoginDone(ReaderHib user) {
        adminLogged = false;
        actualUser = user;
        menu.setVisible(true);
        cargarPantalla(Screens.MENU);
    ...
    public ReaderHib getActualUser() {
        return actualUser;
    }
    ...
    public void deleteNewspaper() {
        cargarPantalla(Screens.DELETENEWSPAPER);
    }

    public void deleteReader() {
        cargarPantalla(Screens.DELETEREADER);
    }
    ...
    public void addReader() {
        cargarPantalla(Screens.ADDREADER);
    }
