...
public class SQLQueries {
    ...
    public static final String DELETE_SUBSCRIPTION = "delete from subscribe where id_newspaper = ?";
    ...
    public static final String UPDATE_READARTICLE = "UPDATE readarticle SET ranking = ? WHERE id = ?";
